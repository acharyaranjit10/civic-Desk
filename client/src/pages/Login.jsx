...
if (result.success) {
  if (result.user.role === 'ward_admin') {
    navigate('/admin');
  } else {
    navigate('/dashboard');
  }
      ...
      <div className="max-w-md w-full space-y-8 bg-white p-10 rounded-2xl shadow-2xl">
        ...
        <div className="mt-6">
          ...
          {/* <div className="mt-4 grid grid-cols-2 gap-3">
            <button
              type="button"
              className="inline-flex justify-center items-center px-4 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-lg text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-nepal-blue"
              onClick={() => {
                setFormData({
                  email: 'demo@user.com',
                  password: 'Demo@123',
